package com.jansir.core.cache.disk;
...
import com.jansir.core.cache.disk.model.LoaderFactory;
import com.jansir.core.cache.disk.model.ModelLoader;
import com.jansir.core.cache.disk.model.Type;

import static com.jansir.core.cache.disk.disklrucache.Util.requireNonNull;
...
public class Cache {
    ...
    /**
     * @param context Any mContext, will not be retained and trans application
     * @return CacheManager
     */
