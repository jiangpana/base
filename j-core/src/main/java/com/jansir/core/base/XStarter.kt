...
/**
 * author: https://github.com/Ifxcyr
 */
object XStarter {
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivity<TestActivity>(this)
     *
     *      //携带参数（可连续多个键值对）
     *      XStarter.startActivity<TestActivity>(this, "Key" to "Value")
     *  </pre>
     *
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivity<TestActivity>(mContext)
     *
     *      //携带参数（可连续多个键值对）
     *      XStarter.startActivity<TestActivity>(mContext, "Key" to "Value")
     *  </pre>
     *
    ...
    inline fun <reified TARGET : Activity> startActivity(
        starter: Context,
        vararg params: Pair<String, Any>
    ) = starter.startActivity(Intent(starter, TARGET::class.java).apply {
        putExtras(*params)
    })
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivity(this, TestActivity::class)
     *
     *      //携带参数（可连续多个键值对）
     *     XStarter.startActivity(
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivity(mContext, TestActivity::class)
     *
     *      //携带参数（可连续多个键值对）
     *     XStarter.startActivity(
     *         mContext, TestActivity::class,
     *         "Key1" to "Value",
     *         "Key2" to 123
     *     )
     *  </pre>
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivityForResult<TestActivity>(this) {
     *          if (it == null) {
     ...
     *  <pre>
     *      //不携带参数
     *      XStarter.startActivityForResult(this, TestActivity::class) {
     *          if (it == null) {
     *              //未成功处理，即（ResultCode != RESULT_OK）
     *          } else {
     *              //处理成功，这里可以操作返回的intent
     ...
     *  示例：
     *  <pre>
     *      XStarter.finish(this, "Key" to "Value")
     *  </pre>
     *
